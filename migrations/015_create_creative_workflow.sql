-- Migration: Create creative workflow tables for AI-assisted social publishing
...
-- Admin API routes use the service role client, which bypasses RLS. Keep direct
-- client access closed until product/customer sharing rules are intentionally added.
